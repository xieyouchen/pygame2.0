...
class UserInterface():
    ...
    def _update(self):
        ...
        for i in self._gameState.isBlockList:
            testObserver.transform(i)
            # for unit in self._gameState.units:
            #     if type(unit).__name__ == "BabaBlock":
            #         print("*******{}{}{}".format(unit._controllable, unit._moveable, unit._passable))
